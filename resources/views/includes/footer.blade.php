   <footer class="site-footer" role="contentinfo">
       <!-- [FOOTER INNER] Max-width wrapper -->
       <div class="footer-inner">
           ...
           <div class="social-links" aria-label="SNSリンク">
               <!-- [SOCIAL LINK] Each anchor opens in a new tab -->
               <a href="https://x.com/TakanesiaID?s=20" class="social-link" aria-label="Twitter / X" target="_blank"
               ...
               <a href="https://www.instagram.com/takanesia.id/" class="social-link" aria-label="Instagram"
               ...
               <a href="https://www.youtube.com/@TakanesiaID" class="social-link" aria-label="YouTube" target="_blank"
                   rel="noopener noreferrer">
                   <!-- SVG YouTube icon -->
                   <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="20" height="20">
                       <path
               ...
               <a href="https://www.tiktok.com/@takanesia.id" class="social-link" aria-label="TikTok" target="_blank"
                   rel="noopener noreferrer">
                   <!-- SVG TikTok icon -->
                   <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" width="20" height="20">
                       <path
               ...
               <a href="https://discord.gg/GqVKP88ysm" class="social-link" aria-label="Discord" target="_blank"
                   rel="noopener noreferrer">
                   <!-- SVG Discord icon -->
           ...
           <p class="copyright">&copy; 2026 TAKANESIA All Rights Reserved.</p>
